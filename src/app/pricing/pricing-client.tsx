...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    monthly: 199,
    annual: 159,
    blurb: "Built for Saudi cafés + restaurants.",
    ...
    rows: [
      {
        ...
        cells: { Free: "5 codes", Starter: "50 codes", Pro: "Unlimited", "Restaurant Pro": "Unlimited", Agency: "Unlimited" },
      },
      {
        category: "core",
        feature: "Static QR codes",
        cells: { Free: true, Starter: true, Pro: true, "Restaurant Pro": true, Agency: true },
      },
      {
        category: "core",
      ...
      },
      {
        ...
        cells: { Free: null, Starter: null, Pro: "Coming Session I", "Restaurant Pro": "Coming Session I", Agency: "Coming Session I" },
      },
    ],
  },
  {
    ...
    rows: [
      {
        ...
        cells: { Free: "Last 30 days", Starter: "All time", Pro: "All time", "Restaurant Pro": "All time", Agency: "All time" },
      },
      {
        category: "analytics",
        feature: "Per-QR analytics drilldown",
        cells: { Free: null, Starter: true, Pro: true, "Restaurant Pro": true, Agency: true },
      },
      {
        category: "analytics",
        feature: "CSV export",
    ...
    rows: [
      {
        ...
        cells: { Free: "Basic", Starter: true, Pro: true, "Restaurant Pro": true, Agency: true },
      },
      {
        category: "branding",
    ...
    rows: [
      {
        ...
        cells: { Free: null, Starter: null, Pro: null, "Restaurant Pro": "Coming Session F", Agency: "Coming Session F" },
      },
      {
        category: "menu",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        cells: { Free: null, Starter: null, Pro: null, "Restaurant Pro": null, Agency: "Coming Sprint 3" },
      },
      {
        category: "support",
